...
(function (root, factory) {
  ...
  const TEMPLATE_PATTERNS = [
    ...
    {
      id: "sexist_incapable",
      re: /\b(?:wom[ae]n|females|girls)\s+(?:can'?t|cannot|shouldn'?t)\s+(?:drive|lead|code|think|do math|be trusted|handle)\b/i,
      categories: ["hate_gender"],
      weight: 0.78,
    ...
    },
    {
      ...
      re: /\b(?:hang|string) them (?:all )?up\b|\bput them (?:all )?against the wall\b|\bdeserves? a bullet\b|\brope for (?:all of )?them\b/i,
      categories: ["violence"],
      weight: 0.88,
